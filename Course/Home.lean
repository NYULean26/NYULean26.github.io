...
The first class is Wednesday, September 2. Bring a laptop. You can [install Lean and the VS Code extension](https://lean-lang.org/install/) before class; we will begin with the [Natural Number Game](https://adam.math.hhu.de/).
